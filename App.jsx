...
function AnimatedRoutes() {
  ...
  return <AnimatePresence mode="wait" initial={false}><motion.div key={location.pathname + location.search} className="min-h-screen pb-24 md:pb-0" {...motionProps}><Routes location={location}>
    ...
    <Route path="/acervo" element={<AdminRouteGuard><AcervoHome /></AdminRouteGuard>} /><Route path="/acervo/:collectionId" element={<AdminRouteGuard><AcervoCollection /></AdminRouteGuard>} /><Route path="/collections" element={<CollectionsHub />} /><Route path="/collections/:collectionCode" element={<CollectionsHub />} /><Route path="/characters" element={<Catalog initialType="characters" />} /><Route path="/forms" element={<FormsCatalog />} /><Route path="/items" element={<Catalog initialType="items" />} /><Route path="/bosses" element={<Catalog initialType="bosses" />} /><Route path="/gacha" element={<Gacha />} /><Route path="/gacha/preferences" element={<Navigate to="/game?tab=disables" replace />} /><Route path="/game" element={<GameHub />} />
