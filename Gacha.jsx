...
function friendlyGachaError(error) {
  ...
  if (message.includes('NO_GACHA_CARDS_AVAILABLE_FOR_FILTER')) return 'Sua Disablelist removeu todas as cartas elegíveis. Reative pelo menos uma coleção.';
      ...
      <main className="mx-auto w-full max-w-6xl px-4 pb-28 pt-8 sm:px-6 lg:px-8">
        <section className="overflow-hidden rounded-[2rem] border border-primary/25 bg-card p-6 sm:p-9">
          ...
          <div className="mt-3 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div><h1 className="text-3xl font-black tracking-[-.04em] sm:text-5xl">Giros individuais ou em lote.</h1><p className="mt-3 max-w-2xl text-sm leading-7 text-muted-foreground">O servidor valida saldo, limite por nível, taxas, pity e sua Disablelist pessoal. O navegador nunca escolhe o resultado.</p></div>
