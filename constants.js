...
export const RARITY_TIERS = {
  ...
  SR:       { label: "[SR] Super Raro",     color: "text-cyan-400",    bg: "bg-cyan-500/10",    border: "border-cyan-500/30",    glow: "shadow-cyan-500/40",            order: 4  },
  SSR:      { label: "[SSR] Esp. Super Raro", color: "text-purple-400", bg: "bg-purple-500/10", border: "border-purple-500/30", glow: "shadow-purple-500/50",           order: 5  },
  UR:       { label: "[UR] Ultra Raro",     color: "text-amber-400",   bg: "bg-amber-500/10",   border: "border-amber-500/30",   glow: "shadow-amber-500/60 shadow-lg", order: 6  },
  LR:       { label: "[LR] Lendário Raro",  color: "text-orange-400",  bg: "bg-orange-500/10",  border: "border-orange-500/30",  glow: "shadow-orange-500/70 shadow-xl", order: 7 },
  MR:       { label: "[MR] Mítico Raro",    color: "text-red-400",     bg: "bg-red-500/10",     border: "border-red-500/30",     glow: "shadow-red-500/80 shadow-xl",   order: 8  },
  BOSS:     { label: "[BOSS]",              color: "text-sky-300",     bg: "bg-sky-400/10",     border: "border-sky-400/40",     glow: "shadow-sky-400/80 shadow-2xl",  order: 9, isBoss: true },
  ANOMALIA: { label: "[ANOMALIA]",          color: "text-fuchsia-400", bg: "bg-fuchsia-500/10", border: "border-fuchsia-500/40", glow: "shadow-fuchsia-500/90 shadow-2xl animate-pulse", order: 10 },
};
...
export const RARITY_ORDER = ["C","UC","R","SR","SSR","UR","LR","MR","BOSS","ANOMALIA"];
