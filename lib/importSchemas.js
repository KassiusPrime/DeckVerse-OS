...
export function validateCard(input = {}) {
  ...
  const personality = typeof input.personality === "string" ? input.personality.trim() : (typeof classifications.personality === "string" ? classifications.personality.trim() : "");
  ...
  const origin = typeof input.origin === "string" ? input.origin.trim() : (typeof classifications.origin === "string" ? classifications.origin.trim() : "");
