...
-- Sem acesso direto do cliente: toda escrita passa pelos RPCs abaixo.
revoke all on table public.gacha_collection_preferences from anon, authenticated;
revoke all on table public.gacha_card_wishes from anon, authenticated;
...
-- Pool do Gacha: respeita a Disablelist pessoal no servidor.
